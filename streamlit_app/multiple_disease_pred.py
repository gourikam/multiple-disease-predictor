...
with st.sidebar:
    ...
    selected = option_menu(
        'Disease Prediction System',
        ['Home', 'Diabetes Prediction', 'Heart Disease Prediction', 'Parkinsons Prediction', 'Health Chatbot'],
        icons=['house', 'activity', 'heart', 'person', 'chat-dots'],
        default_index=0
    )
...
# Health Chatbot Page
    ...
    if user_input := st.chat_input("Ask a health question..."):
        ...
        # Build messages list for API (keep last 10 turns to save tokens)
...
- Describe symptoms, risk factors, prevention strategies, and lifestyle changes
- Help users understand what the prediction results mean and what to do next
...
Keep responses concise and well-structured. Use bullet points where helpful."""

        api_messages = [{"role": "system", "content": system_prompt}] if False else []
                ...
                try:
                    chatbot_response = requests.post(
                        ...
                        json={
                            ...
                            "max_tokens": 600,
                            "system": """You are a knowledgeable, empathetic health assistant for the Health Guard Disease Prediction System.
You specialize in three diseases: Diabetes, Heart Disease, and Parkinson's Disease.
...
Do NOT provide specific diagnoses, prescribe medications, or replace a doctor's advice.""",
                    ...
                    if chatbot_response.status_code == 200:
                        ...
                        reply = f"Sorry, I'm having trouble connecting right now (status {chatbot_response.status_code}). Please try again in a moment."

                except Exception as e:
                    reply = "Sorry, I couldn't connect to the assistant. Please check your internet connection and try again."
